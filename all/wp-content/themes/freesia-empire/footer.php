	...
	<div class="site-info">
		<div class="container">
			...
			if ( is_active_sidebar( 'freesiaempire_footer_options' ) ) :
				...
				<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | <a href="/conditions-generales-dutilisation/">Conditions générales d'utilisation</a>
