...
class Sidebar_Admin {
	...
	public function welcome_notice() {
		...
		<div class="notice notice-success">
			<a class="sidebar-message-close is-dismissible notice-dismiss" href="<?php echo esc_url( wp_nonce_url( remove_query_arg( array( 'activated' ), add_query_arg( 'sidebar-hide-notice', 'welcome' ) ), 'sidebar_hide_notices_nonce', 'sidebar_notice_nonce' ) ); ?>"><?php esc_html_e( 'Dismiss', 'sidebar' ); ?></a>
