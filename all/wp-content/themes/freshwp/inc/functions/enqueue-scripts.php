...
function freshwp_scripts() {
    wp_enqueue_style('freshwp-maincss', get_stylesheet_uri(), array(), NULL);
    wp_enqueue_style('font-awesome', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array(), NULL );

    wp_enqueue_style('freshwp-webfont', '//fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i|Domine:400,700|Oswald:400,700|Poppins:400,700', array(), NULL);
    ...
    wp_enqueue_script('freshwp-customjs', get_template_directory_uri() .'/assets/js/custom.js', array( 'jquery' ), NULL, true);

    if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
        wp_enqueue_script( 'comment-reply' );
    }
}
add_action( 'wp_enqueue_scripts', 'freshwp_scripts' );

/**
 * Enqueue IE compatible scripts and styles.
 */
function freshwp_ie_scripts() {
...
add_action( 'wp_enqueue_scripts', 'freshwp_ie_scripts' );

/**
 * Enqueue customizer styles.
 */
function freshwp_enqueue_customizer_styles() {
    wp_enqueue_style( 'freshwp-customizer-styles', get_template_directory_uri() . '/inc/admin/css/customizer-style.css', array(), NULL );
    wp_enqueue_style('font-awesome', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array(), NULL );
}
add_action( 'customize_controls_enqueue_scripts', 'freshwp_enqueue_customizer_styles' );