                ...
                if ( freshwp_get_option('hide_thumbnail') ) {
                    ...
                    if ( freshwp_get_option('hide_thumbnail_single') ) {
                        ...
                        if ( freshwp_get_option('thumbnail_link') == 'no' ) {
                            the_post_thumbnail('freshwp-large-image', array('class' => 'freshwp-post-thumbnail-single'));
                        } else { ?>
                            <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php /* translators: %s: post title. */ echo esc_attr( sprintf( __( 'Permanent Link to %s', 'freshwp' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_post_thumbnail('freshwp-large-image', array('class' => 'freshwp-post-thumbnail-single')); ?></a>
                <?php   }
                    }
                }
            }
