...
if ( 0 !== $category_id && $custom_posts ) {
	...
	<div class="flexslider-wrapper">
		<img class="carousel-nav-place-holder" style="width:100%;height:auto;" alt="<?php esc_attr_e( 'placeholder', 'canuck' ); ?>" src="<?php echo get_template_directory_uri() . '/images/placeholder15.png';// WPCS: XSS ok. ?>" />
