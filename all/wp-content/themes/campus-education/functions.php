...
/* Theme Credit link */
define('CAMPUS_EDUCATION_SITE_URL','https://www.themesglance.com/');

function campus_education_credit_link() {
    echo "<a href=".esc_url(CAMPUS_EDUCATION_SITE_URL)." target='_blank'>".esc_html__('Themesglance','campus-education')."</a>";
}
