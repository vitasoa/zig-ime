<?php 
		...
		<div id="site-footer-credit">
			<div class="site-section-wrapper site-section-wrapper-footer-credit">
				...
				<p class="site-credit"><?php echo esc_html(get_theme_mod( 'footer-text', $copyright_default )); ?><span class="theme-credit"><?php esc_html_e('Theme by', 'fleming'); ?> <a href="https://www.academiathemes.com/" rel="nofollow,noopener" target="_blank" title="WordPress Themes for Schools and NGOs">AcademiaThemes</a></span></p>
