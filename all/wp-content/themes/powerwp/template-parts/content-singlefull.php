                ...
                if ( powerwp_get_option('hide_thumbnail') ) {
                    ...
                    if ( powerwp_get_option('hide_thumbnail_single') ) {
                        ...
                        if ( powerwp_get_option('thumbnail_link') == 'no' ) {
                            ...
                            <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php /* translators: %s: post title. */ echo esc_attr( sprintf( __( 'Permanent Link to %s', 'powerwp' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_post_thumbnail('powerwp-large-image', array('class' => 'powerwp-post-thumbnail-single')); ?></a>
                <?php   }
                    }
                }
            }
