 ...
 */
function postpress_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function postpress_sanitize_css( $css ) {
 ...
 */
function postpress_sanitize_dropdown_pages( $page_id, $setting ) {
...
function postpress_sanitize_hex_color( $color ) {
	if ( '' === $color )
		return '';
 ...
 */
function postpress_sanitize_html( $html ) {
 ...
 */
function postpress_sanitize_image( $image, $setting ) {
 ...
 */
function postpress_sanitize_nohtml( $nohtml ) {
 ...
 */
function postpress_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function postpress_sanitize_number_range( $number, $setting ) {
 ...
 */
function postpress_sanitize_select( $input, $setting ) {
 ...
 */
function postpress_sanitize_url( $url ) {
