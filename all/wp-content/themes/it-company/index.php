                            ...
                            <div class="navigation">
                                <?php
                                    ...
                                    the_posts_pagination( array(
                                        'prev_text'          => __( 'Previous page', 'it-company' ),
                                        'next_text'          => __( 'Next page', 'it-company' ),
                                        'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'it-company' ) . ' </span>',
                                    ) );
                                ?>
